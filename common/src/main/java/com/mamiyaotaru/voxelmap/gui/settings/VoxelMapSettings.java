...
public final class VoxelMapSettings {
    ...
    public static List<SettingsCategory> create(Runnable openEntityTypeDialog, Supplier<Screen> host) {
        ...
        return List.of(
                ...
                chunkAnalysis(analysis, host),
                new SettingsCategory("controls", "options.voxelmap.category.controls", List.of()),
        ...
        return new SettingsCategory("waypoints", "options.voxelmap.category.waypoints", List.of(
                group("options.voxelmap.group.waypointDisplay",
                        ...
                        choice("waypoints.layout", "options.minimap.waypoints.signLayout", map, () -> map.waypointSignLayout,
                                ...
                                value(1, "options.minimap.waypoints.signLayout.default"), value(2, "options.minimap.waypoints.signLayout.classicTop"), value(3, "options.minimap.waypoints.signLayout.classicBottom"), value(4, "options.minimap.waypoints.signLayout.custom")),
                        toggle("waypoints.names", "options.voxelmap.waypoints.names", map, () -> map.waypointNamesLocation != 0,
                                value -> { map.waypointNamesLocation = value ? 2 : 0; map.waypointSignLayout = 4; },
                                () -> map.waypointsAllowed && map.showWaypointSigns, requires("options.voxelmap.requires.waypointSigns"), 1),
                        SettingsOption.choice("waypoints.namePosition", "options.voxelmap.waypoints.namePosition", tooltip("waypoints.namePosition"),
                                () -> map.waypointNamesLocation == 1 ? 1 : 2,
                                value -> { map.waypointNamesLocation = value; map.waypointSignLayout = 4; },
                        ...
                        toggle("waypoints.distances", "options.voxelmap.waypoints.distances", map, () -> map.waypointDistancesLocation != 0,
                                value -> { map.waypointDistancesLocation = value ? 2 : 0; map.waypointSignLayout = 4; },
                                () -> map.waypointsAllowed && map.showWaypointSigns, requires("options.voxelmap.requires.waypointSigns"), 1),
                        SettingsOption.choice("waypoints.distancePosition", "options.voxelmap.waypoints.distancePosition", tooltip("waypoints.distancePosition"),
                                () -> map.waypointDistancesLocation == 1 ? 1 : 2,
                                value -> { map.waypointDistancesLocation = value; map.waypointSignLayout = 4; },
        ...
        return new SettingsCategory("advanced", "options.voxelmap.category.advanced", List.of(
                group("options.voxelmap.group.worldServer",
                        ...
                        SettingsOption.action("advanced.aliases", "options.voxelmap.advanced.aliases", tooltip("advanced.aliases"),
                                Component.translatable("options.voxelmap.action.edit"), () -> VoxelConstants.getMinecraft().gui.setScreen(new com.mamiyaotaru.voxelmap.gui.GuiServerAliases(host.get(), VoxelConstants.getVoxelMapInstance().getWaypointManager().getServerName())),
    ...
    private static SettingsCategory seedmapper(SeedMapperSettingsManager seed, Supplier<Screen> host) {
        return new SettingsCategory("seedmapper", "options.voxelmap.category.seedmapper", List.of(
                ...
                group("options.voxelmap.group.seedmapperEsp",
                        SettingsAutocomplete.withOptions(SettingsOption.text("seedmapper.espTarget", "options.voxelmap.seedmapper.espTarget", null,
                        ...
                        SettingsOption.slider("seedmapper.espChunks", "options.voxelmap.seedmapper.espChunks", null,
                         ...
                         SettingsOption.toggle("seedmapper.verifyOre", "options.voxelmap.seedmapper.verifyOre", tooltip("seedmapper.verifyOre"),
    ...
    private static SettingsCategory chunkAnalysis(ChunkAnalysisSettingsManager settings, Supplier<Screen> host) {
        return new SettingsCategory("chunkanalysis", "options.voxelmap.category.chunkanalysis", List.of(
                group("options.voxelmap.group.chunkanalysisScan",
                        ...
                        SettingsOption.action("chunkanalysis.scanVoids", "options.voxelmap.chunkanalysis.scanVoids", null,
                                ...
                                () -> !ChunkAnalysisService.get().isRunning(), Component::empty),
                        SettingsOption.action("chunkanalysis.audit", "options.voxelmap.chunkanalysis.audit", null,
                                Component.translatable("options.voxelmap.action.run"),
                                () -> ChunkAnalysisService.get().scanAudit(settings.scanRadius),
                                () -> !ChunkAnalysisService.get().isRunning(), Component::empty),
                        SettingsOption.action("chunkanalysis.unexpected", "options.voxelmap.chunkanalysis.unexpected", null,
                                Component.translatable("options.voxelmap.action.run"),
                                () -> ChunkAnalysisService.get().scanUnexpected(settings.scanRadius),
                                () -> !ChunkAnalysisService.get().isRunning(), Component::empty),
                        SettingsOption.choice("chunkanalysis.continuous", "options.voxelmap.chunkanalysis.continuous", tooltip("chunkanalysis.continuous"),
                                () -> settings.continuousMode,
                                value -> {
                                    settings.continuousMode = value;
                                    MapSettingsManager.instance.saveAll();
                                }, List.of(value("off", "options.voxelmap.chunkanalysis.continuous.off"),
                                        value("voids", "options.voxelmap.chunkanalysis.continuous.voids"),
                                        value("audit", "options.voxelmap.chunkanalysis.continuous.audit"),
                                        value("both", "options.voxelmap.chunkanalysis.continuous.both"))),
                        SettingsOption.slider("chunkanalysis.continuousRadius", "options.voxelmap.chunkanalysis.continuousRadius", tooltip("chunkanalysis.continuousRadius"),
                                () -> (double) settings.continuousRadius,
                                value -> {
                                    settings.continuousRadius = (int) Math.round(value);
                                    MapSettingsManager.instance.saveAll();
                                }, 0, ChunkAnalysisService.MAX_CONTINUOUS_RADIUS, 1,
                                value -> Component.literal((int) Math.round(value) + " chunks"),
                ...
                group("options.voxelmap.group.chunkanalysisDisplay",
                        ...
                        analysisToggle("chunkanalysis.chatFeedback", "options.voxelmap.chunkanalysis.chatFeedback",
                                () -> settings.chatFeedback, value -> settings.chatFeedback = value),
                        ...
                        analysisToggle("chunkanalysis.structureOnly", "options.voxelmap.chunkanalysis.structureOnly",
                                () -> settings.structureOnly, value -> settings.structureOnly = value),
                        ...
                        openScreen("chunkanalysis.colors", "options.voxelmap.chunkanalysis.colors", host, GuiChunkAnalysisColors::new),
