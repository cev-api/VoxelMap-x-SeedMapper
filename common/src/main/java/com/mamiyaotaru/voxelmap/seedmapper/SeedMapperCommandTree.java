        ...
        return LiteralArgumentBuilder.<S>literal(name)
                ...
                .then(LiteralArgumentBuilder.<S>literal("chunkanalysis")
                        ...
                        .then(LiteralArgumentBuilder.<S>literal("scan")
                         ...
                         .then(LiteralArgumentBuilder.<S>literal("audit")
                                 .executes(context -> runRaw(context, runner, "chunkanalysis audit"))
                                 .then(RequiredArgumentBuilder.<S, Integer>argument("radius", IntegerArgumentType.integer(0, 8))
                                         .executes(context -> run(context, runner, "chunkanalysis audit " + IntegerArgumentType.getInteger(context, "radius")))))
                         .then(LiteralArgumentBuilder.<S>literal("unexpected")
                         ...
                         .then(LiteralArgumentBuilder.<S>literal("continuous")
                                 ...
                                 .then(LiteralArgumentBuilder.<S>literal("voids").executes(context -> runRaw(context, runner, "chunkanalysis continuous voids")))
                                 .then(LiteralArgumentBuilder.<S>literal("audit").executes(context -> runRaw(context, runner, "chunkanalysis continuous audit")))
                                 .then(LiteralArgumentBuilder.<S>literal("both").executes(context -> runRaw(context, runner, "chunkanalysis continuous both"))) )
